...
<%@ page import="net.shibboleth.idp.authn.context.ExternalAuthenticationContext" %>
...
try {
	...
	ProfileRequestContext ctx = (ProfileRequestContext)request.getAttribute("opensamlProfileRequestContext");
	AuthenticationContext authCtx = ctx.getSubcontext(AuthenticationContext.class);
	ExternalAuthenticationContext extCtx = authCtx.getSubcontext(ExternalAuthenticationContext.class);
	log.info("extCtx {} ", extCtx);
	if ( extCtx != null ) {
		String pname = extCtx.getPrincipalName();
